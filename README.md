...
```
cd existing_repo
git remote add origin https://gitlab.leverx-group.com/tenant/middleware.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.leverx-group.com/tenant/middleware/-/settings/integrations)
